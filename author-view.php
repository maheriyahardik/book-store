      ...
      <center>
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="dropdown-content">
              <div class="dropdown-content">
                <center>
                <a href="author-view.php" class="nav-item nav-link active">author view</a>
      ...
      <div class="container py-5">
          <div class="row justify-content-center">
              <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown">author view</h1>
  ...
  <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
      <div class="container form-container">
          <div class="text-center">
              <h1 class="mb-5">!author view form!</h1>
          </div>
          <div class="row">
              <div class="col-lg-12">
                <div class="section-tittle d-flex justify-content-center mb-55">
                      <table class="table">
                          ...
                          <tbody>
                                  ...
                                  {
                                    $qDelete = "delete from authors where author_id=" . $_GET["author_id"];
                                  ...
                                  <tr>
                                          ...
                                          <td><?php echo $row['author_number'] ?></td>
                                          <td><?php echo $row['author_city'] ?></td>
                                          <td><img src="<?php echo $row['author_img'] ?>" style="width:100px" /></td>
                                          <td><a href="author-view.php?author_id=<?php echo $row['author_id'];?>" class="btn btn-danger" onclick="confirm('do you want delete?')">Delete</a></td>
                                          <td><a href="author-update.php?author_id=<?php echo $row['author_id'];?>" class="btn btn-primary">Update</a></td>
                                  </tr>
                                  <?php } ?>
                          </tbody>
                      </table>
