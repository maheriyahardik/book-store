            ...
            <div class="dropdown-content">
              <div class="dropdown-content">
                ...
                <a href="book-view.php" class="nav-item nav-link">book view</a>
                  <a href="user-view.php" class="nav-item nav-link active">user view</a>
      ...
      <div class="container py-5">
          <div class="row justify-content-center">
              <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown">user view</h1>
                  <nav aria-label="breadcrumb">
                      <ol class="breadcrumb justify-content-center">
                          <li class="breadcrumb-item"><a class="text-white" href="admin-home.php">Home</a></li>
                          <li class="breadcrumb-item text-white active" aria-current="page">user view</li>
                      </ol>
                  </nav>
              </div>
          </div>
  ...
  <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
      <div class="container form-container">
          <div class="text-center">
              <h1 class="mb-5">!user view form!</h1>
          </div>
          <div class="row">
              <div class="col-lg-12">
                <div class="section-tittle d-flex justify-content-center mb-55">
                      <table class="table">
                          ...
                          <tbody>
                                  ...
                                  // if(isset($_GET["u_id"]))
                                  // {
                                  //   $qDelete = "Update from users where u_id=" . $_GET["u_id"];
                                  ...
                                  <tr>
                                          ...
                                          <td><a href="user-view.php?u_id=<?php echo $row['u_id'];?>"class="btn btn-danger"
                                            onclick="confirm('do you want delete?')">Delete</a></td>
                                          <!-- <td><a href="user-view.php?u_id=<?php echo $row['u_id'];?>"class="btn btn-danger"
                                              onclick="confirm('do you want delete?')">Update</a></td> -->
                                  </tr>
                                  <?php } ?>
                          </tbody>
                      </table>
